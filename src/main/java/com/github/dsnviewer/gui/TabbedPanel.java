...
public class TabbedPanel extends JPanel implements ActionListener, ChangeListener {
    ...
    class LogFilter extends javax.swing.filechooser.FileFilter {
        ...
        public boolean accept(File file) {
            ...
            if (name.endsWith(".dsn")) return true;
            else return false;
        }
    }
    ...
    public void stateChanged(ChangeEvent e) {
        ...
        if (m_frame != null) {
            m_frame.setTitle(APP_NAME + " " + (md.isChanged() ? "* " : "") + md.getFname());
        }
        if (md.getDoc() == null) {
    ...
    public void actionPerformed(ActionEvent actionevent) {
        ...
        if (s.equals("Open")) {
            ...
            JOptionPane.showMessageDialog(this, model.getPinList());
        } else if (s.equals("RECList")) {
            JOptionPane.showMessageDialog(this, model.getRecList2());
            ...
            JOptionPane.showMessageDialog(this, "The DSN Viewer, version " + version + "\n");
        }
    }
