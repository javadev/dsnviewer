...
public class Panel extends JPanel implements ChangeListener, MouseMotionListener {
                ...
                new MouseAdapter() {
                    public void mouseClicked(MouseEvent e) {
                        ...
                        for (int i = 0; i < tc.getModules().size(); i++) {
                            if (md.getPos().getX()
                                            >= (tc.getModules().get(i).getA().getX() - 1)
                                                    * tc.getAlignxy()
                                    && md.getPos().getX()
                                            <= (tc.getModules().get(i).getB().getX() + 1)
                                                    * tc.getAlignxy()
                                    && md.getPos().getY()
                                            >= (tc.getModules().get(i).getA().getY() - 1)
                                                    * tc.getAlignxy()
                                    && md.getPos().getY()
                                            <= (tc.getModules().get(i).getB().getY() + 1)
                                                    * tc.getAlignxy()) {
    ...
    public void mouseMoved(MouseEvent e) {
        ...
        for (int i = 0; i < tc.getModules().size(); i++) {
            if (md.getPos().getX() >= (tc.getModules().get(i).getA().getX() - 1) * tc.getAlignxy()
                    && md.getPos().getX()
                            <= (tc.getModules().get(i).getB().getX() + 1) * tc.getAlignxy()
                    && md.getPos().getY()
                            >= (tc.getModules().get(i).getA().getY() - 1) * tc.getAlignxy()
                    && md.getPos().getY()
                            <= (tc.getModules().get(i).getB().getY() + 1) * tc.getAlignxy()) {
                tagname = tc.getModules().get(i).getStr();
                break;
            }
        }
    ...
    public void stateChanged(ChangeEvent e) {
        ...
        setPreferredSize(
                new Dimension(
                        Math.round(tc.getDetails().getDsize().getWidth() / 5 * axy),
        ...
        for (int i = 0; i < tc.getModules().size(); i++) {
            if (md.getPos().getX() >= (tc.getModules().get(i).getA().getX() - 1) * tc.getAlignxy()
                ...
                g.drawRect(
                        ...
                        Math.round((tc.getModules().get(i).getB().getX() + 1) * tc.getAlignxy())
                                - Math.round(
                                        (tc.getModules().get(i).getA().getX() - 1)
                                                * tc.getAlignxy()),
                        Math.round((tc.getModules().get(i).getB().getY() + 1) * tc.getAlignxy())
                                - Math.round(
                                        (tc.getModules().get(i).getA().getY() - 1)
                                                * tc.getAlignxy()));
                break;
    ...
    private void paintWires(Graphics g) {
        ...
        for (int i = 0; i < tc.getWires().size(); i++) {
            g.drawLine(
                    Math.round(tc.getWires().get(i).getA().getX() * axy),
                ...
                if (tc.getFonts().get(j).getId() == tc.getTexts().get(i).getFont()) {
                    g.setFont(
                            new Font(
                                    ...
                                    Math.abs(
                                            Math.round(
                                                    tc.getFonts().get(j).getHeight() * axy / 5))));
                    break;
                }
            }
            g.drawString(
                    tc.getTexts().get(i).getStr(),
    ...
    private void paintSymbolTexts(Graphics g, int i) {
        ...
        for (int j = 0; j < tc.getSymbols().get(i).getField2s().size(); j++) {
            if (tc.getSymbols().get(i).getField2s().get(j).getShow() == 1) {
                g.setFont(new Font("arial", Font.PLAIN, Math.abs(Math.round(10 * axy / 5))));
                g.drawString(
                ...
                if (tc.getFonts().get(l).getId()
                    ...
                    g.setFont(
                            new Font(
                                    ...
                                    Math.abs(
                                            Math.round(
                                                    tc.getFonts().get(l).getHeight() * axy / 5))));
                    break;
                }
            }
            ...
            g.setColor(
                    new Color(
                            tc.getSymbolDefs()
                                    ...
                                    .getColor()));
            g.drawString(
                    tc.getSymbolDefs().get(j).getTinyCadSymbol().getLabels().get(k).getStr(),
                    Math.round(
                            (tc.getSymbols().get(i).getPos().getX()
                                            + tc.getSymbolDefs()
                                                    .get(j)
    ...
    private void paintSymbolPinTexts1(
            Graphics g, int j, int k, int x1, int y1, int x2, int deltafontx) {
        if (tc.getSymbolDefs().get(j).getTinyCadSymbol().getPins().get(k).getStr() != null
                && (tc.getSymbolDefs().get(j).getTinyCadSymbol().getPins().get(k).getShow() == 2
                        || tc.getSymbolDefs().get(j).getTinyCadSymbol().getPins().get(k).getShow()
                                == 3)) {
            //      if (tc.getSymbolDefs().get(j).getTinyCadSymbol().getPins().get(k).getWhich() !=
            // 0) {
            g.drawString(
    ...
    private void paintSymbolPinWhich1(
            Graphics g,
            int j,
            int k,
            int x1,
        ...
        if (tc.getSymbolDefs().get(j).getTinyCadSymbol().getPins().get(k).getWhich() == 1) {
            g.drawOval(
                    Math.round(
                            (deltafontx >= 0
                                    ? Math.max(x1, x2) - Math.round(axy * 0.6)
                                    : Math.min(x1, x2) - Math.round(axy * 0.6))),
                    Math.round(
                            (deltafonty >= 0
                                    ? Math.max(y1, y2) - Math.round(axy * 0.6)
                                    : Math.min(y1, y2) - Math.round(axy * 0.6))),
                    Math.round(axy * 1.2f),
                    Math.round(axy * 1.2f));
        }
        g.setColor(savecolor);
    ...
    private void paintSymbolPinWhich2(
            Graphics g,
            int j,
            int k,
            int x1,
        ...
        if (tc.getSymbolDefs().get(j).getTinyCadSymbol().getPins().get(k).getWhich() == 2) {
            ...
            int y11 =
                    Math.round(
                            (deltafonty >= 0
                                    ? Math.max(y1, y2) - Math.round(axy * 0)
                                    : Math.min(y1, y2) - Math.round(axy * 0)));
            int x12 =
                    Math.round(
                            (deltafontx >= 0
                                    ? Math.max(x1, x2) + Math.round(axy * 0.6)
            ...
            int x13 =
                    Math.round(
                            (deltafontx >= 0
                                    ? Math.max(x1, x2) + Math.round(axy * 0)
                                    : Math.min(x1, x2) + Math.round(axy * 0)));
            int y13 =
                    Math.round(
                            (deltafonty >= 0
                                    ? Math.max(y1, y2) - Math.round(axy * 0.9)
                                    : Math.min(y1, y2) - Math.round(axy * 0.9)));

            g.drawLine(x11, y11, x12, y12);
            g.drawLine(x12, y12, x13, y13);
            g.drawLine(x13, y13, x11, y11);
        }
        g.setColor(savecolor);
    }

    private void paintSymbolPinWhich3(
            Graphics g,
            int j,
            int k,
            int x1,
        ...
        if (tc.getSymbolDefs().get(j).getTinyCadSymbol().getPins().get(k).getWhich() == 3) {
            ...
            int y11 =
                    Math.round(
                            (deltafonty >= 0
                                    ? Math.max(y1, y2) - Math.round(axy * 0.7)
                                    : Math.min(y1, y2) - Math.round(axy * 0.7)));
            int x12 =
                    Math.round(
                            (deltafontx >= 0
                                    ? Math.max(x1, x2) + Math.round(axy * 0.6)
            ...
            int y13 =
                    Math.round(
                            (deltafonty >= 0
                                    ? Math.max(y1, y2) - Math.round(axy * 1.6)
                                    : Math.min(y1, y2) - Math.round(axy * 1.6)));
    ...
    private void paintSymbolPinTexts2(
            Graphics g,
            int j,
            int k,
            int x1,
