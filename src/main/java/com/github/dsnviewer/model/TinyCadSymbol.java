...
//|direction|=|2| |elec|=|1| |length|=|20| |number|=|y1| |number_pos|=|0| |part|=|0| |pos|=|0,-34| |show|=|2| |which|=|0|
    NamedNodeMap nm = el.getAttributes();
    Pin dpin = new Pin();
